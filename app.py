...
figure2 = px.bar(ventes_produit, x='produit', y='qte', title='Quantité vendue par produit')
...
figure3 = px.bar(ca_produit, x='produit', y='ca', title="Chiffre d'affaires par produit")
